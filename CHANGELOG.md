...
- We fixed an issue where the entry type list in the New Entry dialog could be cut off with no way to scroll to all types. [#11589](https://github.com/JabRef/jabref/issues/11589)
