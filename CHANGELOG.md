...
- We fixed an issue where the New Entry dialog did not open large enough to show all entry types and could cut them off with no way to scroll. [#11589](https://github.com/JabRef/jabref/issues/11589)
